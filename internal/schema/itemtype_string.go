...
func _() {
	...
	_ = x[itemTypeIntersection-20]
	_ = x[itemParenLeft-21]
	_ = x[itemParenRight-22]
	_ = x[itemBraceLeft-23]
	_ = x[itemBraceRight-24]
	_ = x[itemBracketLeft-25]
	_ = x[itemBracketRight-26]
	_ = x[itemAngledLeft-27]
	_ = x[itemAngledRight-28]
}

const _itemType_name = "ErrorEOFIdentifierCommentStringLiteralKeywordClassKeywordImplementsKeywordThisKeywordCtx\"&&\"\"||\"\"!\"\"=\"\"==\"\"=>\"\".\"\":\"\",\"\";\"\"|\"\"&\"\"(\"\")\"\"{\"\"}\"\"[\"\"]\"\"<\"\">\""

var _itemType_index = [...]uint8{0, 5, 8, 18, 25, 38, 50, 67, 78, 88, 92, 96, 99, 102, 106, 110, 113, 116, 119, 122, 125, 128, 131, 134, 137, 140, 143, 146, 149, 152}
